...
#
# Generated by export_simulation on Sat Jan 30 20:37:31 -0500 2021
#
################################################################################
...
'-reset_run' switch to the './server.sh' script.
...
./server.sh -noclean_files

For more information on the script, please type './server.sh -help'.
